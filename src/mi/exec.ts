...
import { GDBTargetParams, MIResponse } from './base';
...
export function sendTargetSelect(gdb: GDBBackend, params: GDBTargetParams) {
    return gdb.sendCommand(`-target-select ${params.name} ${params.arguments}`);
}
